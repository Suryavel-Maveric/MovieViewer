...
class SearchViewModel @ViewModelInject constructor(private val mvApi: MvApi) : ViewModel() {

    private var itemPagedList: LiveData<PagedList<SearchItem>>? = null


    fun getSearchItemPagedList(query: String): LiveData<PagedList<SearchItem>> {
